...
<body class="bg-[#080914]">
    <div>
        <div class="flex xl:flex-row lg:flex-row xl:justify-around lg:justify-around items-center xl:h-screen lg:h-screen md-h-screen sm:h-screen max-[639px]:h-screen max-[345px]:h-screen xl:mx-[5rem] lg:mx-[3rem] md:mx-[3rem] md:flex-col md:justify-center sm:mx-[3rem] sm:flex-col sm:justify-center  max-[639px]:mx-[2rem] max-[639px]:flex-col max-[639px]:justify-center max-[345px]:mx-[2rem] max-[345px]:flex-col max-[345px]:justify-center md:leading-snug sm:leading-snug max-[639px]:leading-snug max-[345px]:leading-snug">
            <p class="font-black xl:text-[10rem] lg:text-[10rem] md:text-[8rem] sm:text-[7rem]  max-[639px]:text-[5.5rem] max-[345px]:text-[4rem] bg-gradient-to-r from-[#9fa1dd] via-[#3539cc] to-[#242779] inline-block text-transparent bg-clip-text">CS31A</p>
